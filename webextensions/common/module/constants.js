...
export  const kTSTAPI_NOTIFY_SHUTDOWN       = 'shutdown'; // defined but not notified for now.
export  const kTSTAPI_NOTIFY_SIDEBAR_SHOW   = 'sidebar-show';
export  const kTSTAPI_NOTIFY_SIDEBAR_HIDE   = 'sidebar-hide';
...
export  const kTSTAPI_NOTIFY_TAB_MOUSEMOVE  = 'tab-mousemove';
export  const kTSTAPI_NOTIFY_TAB_MOUSEOVER  = 'tab-mouseover';
export  const kTSTAPI_NOTIFY_TAB_MOUSEOUT   = 'tab-mouseout';
...
export  const kTSTAPI_NOTIFY_TRY_MOVE_FOCUS_FROM_CLOSING_CURRENT_TAB = 'try-move-focus-from-closing-current-tab';
export  const kTSTAPI_GET_TREE              = 'get-tree';
export  const kTSTAPI_ATTACH                = 'attach';
export  const kTSTAPI_DETACH                = 'detach';
export  const kTSTAPI_INDENT                = 'indent';
export  const kTSTAPI_DEMOTE                = 'demote';
export  const kTSTAPI_OUTDENT               = 'outdent';
export  const kTSTAPI_PROMOTE               = 'promote';
export  const kTSTAPI_MOVE_UP               = 'move-up';
export  const kTSTAPI_MOVE_DOWN             = 'move-down';
export  const kTSTAPI_FOCUS                 = 'focus';
export  const kTSTAPI_DUPLICATE             = 'duplicate';
...
export  const kTSTAPI_COLLAPSE_TREE         = 'collapse-tree';
export  const kTSTAPI_EXPAND_TREE           = 'expand-tree';
export  const kTSTAPI_ADD_TAB_STATE         = 'add-tab-state';
export  const kTSTAPI_REMOVE_TAB_STATE      = 'remove-tab-state';
export  const kTSTAPI_SCROLL                = 'scroll';
export  const kTSTAPI_SCROLL_LOCK           = 'scroll-lock';
export  const kTSTAPI_SCROLL_UNLOCK         = 'scroll-unlock';
export  const kTSTAPI_NOTIFY_SCROLLED       = 'scrolled';
export  const kTSTAPI_BLOCK_GROUPING        = 'block-grouping';
export  const kTSTAPI_UNBLOCK_GROUPING      = 'unblock-grouping';

export const kTSTAPI_CONTEXT_MENU_UPDATED    = 'fake-contextMenu-updated';
export const kTSTAPI_CONTEXT_MENU_GET_ITEMS  = 'fake-contextMenu-get-items';
