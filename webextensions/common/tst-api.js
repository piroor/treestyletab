...
export const kNOTIFY_TRY_TREE_COLLAPSED_STATE_CHANGE = 'try-tree-collapsed-state-change';
...
export const kLOCK_TREE_COLLAPSED   = 'lock-tree-collapsed';
export const kUNLOCK_TREE_COLLAPSED = 'unlock-tree-collapsed';
export const kTOGGLE_LOCK_TREE_COLLAPSED = 'toggle-lock-tree-collapsed';
