...
export const kNOTIFY_TABBAR_TOP_CLICKED      = 'tabbar-top-clicked';
export const kNOTIFY_TABBAR_TOP_MOUSEDOWN    = 'tabbar-top-mousedown';
export const kNOTIFY_TABBAR_TOP_MOUSEUP      = 'tabbar-top-mouseup';
export const kNOTIFY_TABBAR_TOP_KEYDOWN      = 'tabbar-top-keydown';
export const kNOTIFY_TABBAR_TOP_KEYUP        = 'tabbar-top-keyup';
export const kNOTIFY_TABBAR_TOP_INPUT        = 'tabbar-top-input';
export const kNOTIFY_TABBAR_TOP_COMPOSITIONSTART  = 'tabbar-top-compositionstart';
export const kNOTIFY_TABBAR_TOP_COMPOSITIONUPDATE = 'tabbar-top-compositionupdate';
export const kNOTIFY_TABBAR_TOP_COMPOSITIONEND    = 'tabbar-top-compositionend';
export const kNOTIFY_TABBAR_TOP_FOCUS        = 'tabbar-top-focus';
export const kNOTIFY_TABBAR_TOP_BLUR         = 'tabbar-top-blur';
export const kNOTIFY_TABBAR_BOTTOM_CLICKED   = 'tabbar-bottom-clicked';
export const kNOTIFY_TABBAR_BOTTOM_MOUSEDOWN = 'tabbar-bottom-mousedown';
export const kNOTIFY_TABBAR_BOTTOM_MOUSEUP   = 'tabbar-bottom-mouseup';
export const kNOTIFY_TABBAR_BOTTOM_KEYDOWN   = 'tabbar-bottom-keydown';
export const kNOTIFY_TABBAR_BOTTOM_KEYUP     = 'tabbar-bottom-keyup';
export const kNOTIFY_TABBAR_BOTTOM_INPUT     = 'tabbar-bottom-input';
export const kNOTIFY_TABBAR_BOTTOM_COMPOSITIONSTART  = 'tabbar-bottom-compositionstart';
export const kNOTIFY_TABBAR_BOTTOM_COMPOSITIONUPDATE = 'tabbar-bottom-compositionupdate';
export const kNOTIFY_TABBAR_BOTTOM_COMPOSITIONEND    = 'tabbar-bottom-compositionend';
export const kNOTIFY_TABBAR_BOTTOM_FOCUS     = 'tabbar-bottom-focus';
export const kNOTIFY_TABBAR_BOTTOM_BLUR      = 'tabbar-bottom-blur';
