...
export const kCOMMAND_APPLY_TREE_TRANSACTION                        = 'treestyletab:apply-tree-transaction';
...
export const kCOMMAND_GET_RECT                      = 'treestyletab:get-rect';
...
export const kPARENT_TAB_OPERATION_BEHAVIORS = new Set([
  kPARENT_TAB_OPERATION_BEHAVIOR_ENTIRE_TREE,
  kPARENT_TAB_OPERATION_BEHAVIOR_PROMOTE_FIRST_CHILD,
  ...
  kPARENT_TAB_OPERATION_BEHAVIOR_SIMPLY_DETACH_ALL_CHILDREN,
  kPARENT_TAB_OPERATION_BEHAVIOR_REPLACE_WITH_GROUP_TAB,
]);
...
export const kTABBAR_UPDATE_REASON_TAB_CLOSE_PINNED = 1 << 7;
