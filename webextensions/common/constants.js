...
export const kCOMMAND_NOTIFY_TAB_COLLAPSED_STATE_CHANGING = 'treestyletab:notify-tab-collapsed-state-changing';
export const kCOMMAND_NOTIFY_TAB_COLLAPSED_STATE_CHANGED  = 'treestyletab:notify-tab-collapsed-state-changed';
export const kCOMMAND_NOTIFY_TREE_COLLAPSED_STATE_CHANGING = 'treestyletab:notify-tree-collapsed-state-changing';
...
export const kCOMMAND_NOTIFY_TAB_MOVING              = 'treestyletab:notify-tab-moving';
