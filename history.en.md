# History
 ...
 - master/HEAD
   ...
   * Active tab, previously active tab, sound playing tabs, and tabs sharing camera/microphone/screen are stickable to edges of the tab bar when they are scrolled out.
