# 更新履歴
 ...
 - master/HEAD
   ...
   * メニュー項目とキーボードショートカット用コマンドから「選択中のタブを新しいグループにする」「タブのグループ化を解除」「現在のタブを1階層深くする」「現在のタブを1階層浅くする」を削除した（これらの機能は新しいヘルパーアドオンの[TST More Tree Commands](https://github.com/piroor/tst-more-tree-commands)に分割されました）
